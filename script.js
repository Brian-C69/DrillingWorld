            ...
            switch (categoryId) {
                    case 'appliedDrillingFormulas':
                        var calculatorLinks = [
                            ...
                            "<a href='calculators/MaximumROPBrforeFracturingFormation.phps' class='list-group-item list-group-item-action'>Maximum ROP Before Fracturing Formation</a>",
                            ...
                            "<a href='calculators/Pressure' class='list-group-item list-group-item-action'>Pressure required to break circulation</a>",
                    ...
                    case 'basicDrillingFormulas':
                        var calculatorLinks = [
                            ...
                            "<a href='calculators/EquivalentCirculatingDensity(ECD)' class='list-group-item list-group-item-action'>Equivalent Circulating Density (ECD)</a>",
                            ...
                            "<a href='calculators/Pressure and Force' class='list-group-item list-group-item-action'>Pressure Gradient</a>",

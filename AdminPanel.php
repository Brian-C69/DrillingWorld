...
$sql = "SELECT aid, username, name, gender, position, birthday, email, phone_number, created_at, last_loggedin FROM admins";
    ...
    <body>
        ...
        <div class="container text-center">
            <p>
                ...
                <a href="AdminAddAdminPanel.php"><button type="button" class="btn btn-primary">Add Admin</button></a>
            </p>
        </div>
                ...
                <table id="userTable" class="table table-light">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(6)">Birthday</th>
                            <th scope="col" onclick="sortTable(7)">Email</th>
                            <th scope="col" onclick="sortTable(8)">Phone Number</th>
                            <!-- <th scope="col" onclick="sortTable(9)">Created</th>
                            <th scope="col" onclick="sortTable(10)">Last Loggin</th> -->
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            //echo "<td>{$row['last_loggedin']}</td>";
                            echo "<td>
                            <a href='edit_admin.php?aid={$row['aid']}' class='btn btn-primary btn-sm'>Edit</a>
                            <a href='delete_admin.php?aid={$row['aid']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this user?\")'>Delete</a>
                        </td>";
                            echo "</tr>";
                            $index++;
                        }

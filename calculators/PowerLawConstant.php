...
<html lang="en">
    <head>
        ...
        <title>Power Law Constant</title>
    </head>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91884,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

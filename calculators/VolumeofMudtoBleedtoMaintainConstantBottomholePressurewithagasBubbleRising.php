...
<html lang="en">
    <head>
        ...
        <title>Volume of Mud to Bleed to Maintain Constant Bottomhole Pressure with a gas Bubble Rising</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103272,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

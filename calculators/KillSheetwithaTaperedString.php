...
<html lang="en">
    <head>
        ...
        <title>Kill Sheet with a Tapered String</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103213,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

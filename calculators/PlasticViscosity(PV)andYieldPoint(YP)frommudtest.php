...
<html lang="en">
    <head>
        ...
        <title>Plastic Viscosity (PV) and Yield Point (YP) from mud test</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91763,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

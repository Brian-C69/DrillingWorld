...
<html lang="en">
    <head>
        ...
        <title>Maximum Possible Influx Height When Equal To Maximum Allowable Shut In Casing Pressure</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91928,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

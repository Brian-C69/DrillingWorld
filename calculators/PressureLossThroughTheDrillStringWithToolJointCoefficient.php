...
<html lang="en">
    <head>
        ...
        <title>Pressure Loss Through The Drill String With Tool Joint Coefficient</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91889,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

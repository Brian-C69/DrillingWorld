...
<html lang="en">
    <head>
        ...
        <title>Fracture Gradient Determination Subsea Application</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103438,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

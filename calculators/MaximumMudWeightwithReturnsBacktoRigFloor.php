...
<html lang="en">
    <head>
        ...
        <title>Maximum Mud Weight with Returns Back to Rig Floor</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103290,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Loss of Overbalance Due to Falling Mud Level</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103097,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

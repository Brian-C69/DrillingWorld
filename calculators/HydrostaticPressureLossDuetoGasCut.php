...
<head>
    ...
    <title>Hydrostatic Pressure Loss Due to Gas Cut</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91919,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Pressure Loss in Annulus with Corrected Coefficient</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91887,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

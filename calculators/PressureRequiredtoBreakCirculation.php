...
<html lang="en">
    <head>
        ...
        <title>Pressure Required to Break Circulation</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91570,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

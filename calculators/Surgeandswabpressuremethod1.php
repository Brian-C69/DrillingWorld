...
<html lang="en">
    <head>
        ...
        <title>Surge And Swab Pressure Method#1</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91892,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

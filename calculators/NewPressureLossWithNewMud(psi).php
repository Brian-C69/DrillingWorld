...
<html lang="en">
    <head>
        ...
        <title>New Pressure Loss With New Mud (psi)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91934,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

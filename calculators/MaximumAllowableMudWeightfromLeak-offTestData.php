...
<html lang="en">
    <head>
        ...
        <title>Maximum Allowable Mud Weight from Leak-off Test Data</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103093,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

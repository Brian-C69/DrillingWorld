...
<head>
    ...
    <title>D-Exponent and D-Exponent Corrected</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91621,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

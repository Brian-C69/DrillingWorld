...
<html lang="en">
    ...
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91933,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

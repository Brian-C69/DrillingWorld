...
<html lang="en">
    <head>
        ...
        <title>Reduce Mud Weight By Dilution</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91764,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

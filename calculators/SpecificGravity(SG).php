...
<html lang="en">
    <head>
        ...
        <title>Specific Gravity (SG)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:92114,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

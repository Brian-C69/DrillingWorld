...
<html lang="en">
    <head>
        <?php include '../includes/headersCal.php'; ?><title>Lube Increment (MI)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91926,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

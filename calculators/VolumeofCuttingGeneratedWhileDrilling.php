...
<html lang="en">
    <head>
        ...
        <title>Volume of Cutting Generated While Drilling</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91577,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

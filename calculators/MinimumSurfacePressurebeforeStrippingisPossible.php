...
<html lang="en">
    <head>
        ...
        <title>Minimum Surface Pressure before Stripping is Possible</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103251,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<head>
    ...
    <title>Critical Rpm To Prevent Pipe Failure Due To High Vibration</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91767,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Maximum Pressures when Circulating Out a kick (Moore Equations)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103234,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

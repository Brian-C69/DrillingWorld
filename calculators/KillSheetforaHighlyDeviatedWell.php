...
<html lang="en">
    <head>
        ...
        <title>Kill Sheet for a Highly Deviated Well</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103214,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Formation Pressure (FP) with the Well Shut-in on a Kick</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103228,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

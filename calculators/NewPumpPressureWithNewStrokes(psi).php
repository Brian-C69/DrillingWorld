...
<html lang="en">
    <head>
        ...
        <title>New Pump Pressure With New Strokes (psi)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91935,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Leak Off Test Pressure Converted to Equivalent Mud Weight (LOT)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91646,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Adjusting Choke Line Pressure Loss for Higher Mud Weight</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103287,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

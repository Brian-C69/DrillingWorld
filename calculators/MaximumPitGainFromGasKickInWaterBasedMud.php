...
<html lang="en">
    <head>
        ...
        <title>Maximum Pit Gain From Gas Kick In Water Based Mud</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91930,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

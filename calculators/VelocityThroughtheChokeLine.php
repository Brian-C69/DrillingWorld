...
<html lang="en">
    <head>
        ...
        <title>Velocity Through the Choke Line</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103285,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Maximum Surface Pressure From Gas Influx In Water Based Mud</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91931,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

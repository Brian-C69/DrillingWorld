...
<head>
    ...
    <title>Buoyancy Factor (Bf) With Different Fluid Weight Inside And Outside</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91613,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Critical Annular Velocity and Critical Flow Rate</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103435,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Casing Pressure Decrease when Bringing Well on Choke</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103277,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Pressure Drop Across Bit (psi)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91885,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

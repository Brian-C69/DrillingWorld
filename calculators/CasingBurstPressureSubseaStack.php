...
<html lang="en">
    <head>
        ...
        <title>Casing Burst Pressure Subsea Stack</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103283,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<head>
    ...
    <title>Adjusted Maximum Allowable Shut-in Casing Pressure For New Mud Weight</title>
</head>
<body>
...
<div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91911,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

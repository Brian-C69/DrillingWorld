...
<html lang="en">
    <head>
        ...
        <title>Reduction in Bottomhole Pressure if Riser is Disconnected</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103291,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<head>
    ...
    <title>Hydraulic Horse Power (HPP)</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91880,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<head>
    ...
    <title>Impact Force of Jet Nozzles on Bottom Hole</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91881,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Casing Pressure Increase from Striping into Influx</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103255,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<head>
    ...
    <title>Bit Hydraulic Horsepower Per Area of Drill Bit (HSI)</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91873,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

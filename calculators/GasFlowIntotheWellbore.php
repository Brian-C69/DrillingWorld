...
<html lang="en">
    <head>
        ...
        <title>Gas Flow Into the Wellbore</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103243,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Bit Nozzle Selecting Optimized Hydraulics</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103298,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

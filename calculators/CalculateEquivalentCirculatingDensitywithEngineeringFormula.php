...
<head>
    ...
    <title>Calculate Equivalent Circulating Density with Engineering Formula</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91789,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

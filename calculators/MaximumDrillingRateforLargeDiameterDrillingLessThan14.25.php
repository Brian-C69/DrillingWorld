...
<html lang="en">
    <head>
        ...
        <title>Maximum Drilling Rate for  Large Diameter Drilling Less Than 14.25</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103094,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

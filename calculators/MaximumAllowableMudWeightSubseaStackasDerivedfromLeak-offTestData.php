...
<html lang="en">
    <head>
        ...
        <title>Maximum Allowable Mud Weight, Subsea Stack as Derived from Leak-off Test Data</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103279,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Calculate Choke Line Pressure Loss (CLPL)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103284,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Hydrostatic Pressure Decrease at TD Caused by Gas Cut Mud</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103232,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

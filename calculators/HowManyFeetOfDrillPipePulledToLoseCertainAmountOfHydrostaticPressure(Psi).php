...
<head>
    ...
    <title>How Many Feet Of Drill Pipe Pulled To Lose Certain Amount Of Hydrostatic Pressure (Psi)</title>
</head>
<body>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91627,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

...
<html lang="en">
    <head>
        ...
        <title>Shut-in Drill Pipe Pressure (SIDPP)</title>
    </head>
    <body>
        ...
        <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:103230,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>

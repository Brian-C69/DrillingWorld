...
<head>
    ...
    <title>Bulk Density of Cuttings by using Mud Balance</title>
</head>
    ...
    <div ng-app="calculoid" ng-controller="CalculoidMainCtrl" ng-init="init({calcId:91750,apiKey:'883ccb68619b2c78af4e8'})" ng-include="load()"></div>
